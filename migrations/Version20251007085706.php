 ...
 */
final class Version20251007085706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE facture (id INT AUTO_INCREMENT NOT NULL, fournisseur_id INT DEFAULT NULL, acheteur_id INT DEFAULT NULL, numero_facture VARCHAR(50) NOT NULL, date_facture DATE NOT NULL, type_facture VARCHAR(10) NOT NULL, devise VARCHAR(3) NOT NULL, net_apayer NUMERIC(10, 2) NOT NULL, date_echeance DATE DEFAULT NULL, date_livraison DATE DEFAULT NULL, mode_paiement VARCHAR(10) DEFAULT NULL, reference_paiement VARCHAR(100) DEFAULT NULL, taxes JSON DEFAULT NULL, profil_factur_x VARCHAR(20) NOT NULL, commentaire VARCHAR(255) DEFAULT NULL, charges DOUBLE PRECISION NOT NULL, INDEX IDX_FE866410670C757F (fournisseur_id), INDEX IDX_FE86641096A7BB5F (acheteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
